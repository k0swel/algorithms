...
> *В пятом пункте мы не указывем индекс Wall в массив, поскольку он уже лежит на своей правильной позиции(ВСЕ элементы меньше или равные его расположены слева; ВСЕ элементы больше его расположены справа)*
...
[*Видео, иллюстрирующее алгоритм быстрой сортировки*](https://www.youtube.com/watch?v=4s-aG6yGGLU&t=166s) ![youtube16](https://github.com/user-attachments/assets/20421170-866c-4ca2-8c20-2692c2c01787)
