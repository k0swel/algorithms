...
## Быстрая сортировка.
_Быстрая сортировка_ - это метод сортировки массивов, разработанный программистом Хоаром. Алгоритм включает в себя следующую логику:
...
> *В пятом пункте мы не указывем индекс Wall в массив, поскольку он уже лежит на своей правильной позиции(ВСЕ элементе меньше или равные его расположены слева; ВСЕ элементы больше его расположены справа)*
